...
public class LoginServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) 
		...
		if(usu != null && usu.getUsuario().toString().equals(usuario) && usu.getPassword().toString().equals(contraseña)){
		...
		else if(usu != null && usu.getUsuario().toString().equals(usuario) && !usu.getPassword().equals(contraseña)){
